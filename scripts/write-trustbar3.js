...
// Per-logo widths for visual balance
...
export function TrustBar({ logos, showSteadfastCallout }: TrustBarProps) {
  return (
    <section style={{ background: 'var(--color-bg-light)', padding: 'var(--space-md) 0 var(--space-lg)', borderTop: '1px solid var(--color-border)' }}>
      <PageWrapper>
        ...
        {showSteadfastCallout && (
          ...
          >
            <img
              ...
              alt="Steadfast Group"
              style={{ width: DEFAULT_WIDTH, height: 'auto', objectFit: 'contain', filter: 'grayscale(100%) opacity(0.6)' }}
              loading="lazy"
            />
