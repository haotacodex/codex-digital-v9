  ...
  if (submitted) {
    return (
      <div style={{ padding: 'var(--space-xl)', textAlign: 'center' }}>
        <h2>Thank you</h2>
        <p style={{ color: 'var(--color-text-muted)' }}>We have received your message and will be in touch within 1 business day.</p>
      </div>
    )
  }
  ...
  return (
    ...
    >
      ...
      <div style={{ display: 'flex', flexDirection: 'column', gap: '4px' }} className="md:col-span-2">
        <label style={{ fontSize: 'var(--text-caption)', fontWeight: 600 }}>Message</label>
